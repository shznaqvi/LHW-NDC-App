...
import edu.aku.hassannaqvi.wellnessscale.core.UserAuth;
import edu.aku.hassannaqvi.wellnessscale.database.DatabaseHelper;
import edu.aku.hassannaqvi.wellnessscale.databinding.ActivityChangePasswordBinding;
import edu.aku.hassannaqvi.wellnessscale.workers.UserWorker;
...
public class ChangePasswordActivity extends AppCompatActivity {
    ...
    public void onShowPasswordClick(View view) {
        ...
        if (view.getId() == R.id.showPasswordOld) {
            p = bi.passwordOld;
        } else if (view.getId() == R.id.showPassword1) {
            p = bi.password1;
        } else if (view.getId() == R.id.showPassword2) {
            p = bi.password2;
        }
