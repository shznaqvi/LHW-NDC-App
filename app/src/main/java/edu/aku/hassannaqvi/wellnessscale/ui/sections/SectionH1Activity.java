...
import edu.aku.hassannaqvi.wellnessscale.databinding.ActivitySectionH1Binding;
...
public class SectionH1Activity extends AppCompatActivity {
    ...
    private boolean updateDB() {
        ...
        long updcount = 0;
        try {
            updcount = db.updatesFamilyMembersColumn(TableContracts.FamilyMembersTable.COLUMN_SH1, familyMembers.sH1toString());
